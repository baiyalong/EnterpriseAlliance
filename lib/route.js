...
FlowRouter.route('/user/register', { action: function () { BlazeLayout.render("user_register"); } });
...
FlowRouter.route('/user/infoList', { action: function () { BlazeLayout.render("layout_user", { content: "user_infoList" }); } });
FlowRouter.route('/user/infoDetail', { action: function () { BlazeLayout.render("layout_user", { content: "user_infoDetail" }); } });
FlowRouter.route('/user/infoEdit', { action: function () { BlazeLayout.render("layout_user", { content: "user_infoEdit" }); } });
