...
FlowRouter.route('/user', { action: function () { Meteor.userId() ? FlowRouter.go('/user/information') : FlowRouter.go('/user/login') } });
FlowRouter.route('/user/register', { action: function () { BlazeLayout.render("layout_user", { content: "user_register" }); } });
FlowRouter.route('/user/login', { action: function () { BlazeLayout.render("layout_user", { content: "user_login" }); } });
...
FlowRouter.route('/admin', { action: function () { Meteor.userId() ? FlowRouter.go('/admin/information') : FlowRouter.go('/admin/login') } });
FlowRouter.route('/admin/login', { action: function () { BlazeLayout.render("layout_admin", { content: "admin_login" }); } });
